...
// Oficinas de exemplo para popular o banco (formato correto para registro)
const workshops = [
  {
    name: "João Silva",
  ...
  },
  {
    ...
    email: "carlos@oficinaciclist.com.br",
    password: "123456",
    phone: "(11) 1234-5678",
    userType: "workshop",
    workshopData: {
...
async function populateWorkshops() {
  console.log('🚀 Iniciando população de oficinas...');
  
  for (const workshop of workshops) {
    try {
      const result = await makeRequest(workshop);
      console.log(`✅ Oficina "${workshop.name}" criada com sucesso!`);
